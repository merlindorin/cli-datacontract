...
func (i *BigqueryAllCMD) Run(parent *BigqueryCMD, co *cmd.Commons) error {
	...
	for {
		...
		for {
			...
			l.Info(
				"Table collected",
				zap.String("projectID", table.ProjectID),
				zap.String("datasetID", table.DatasetID),
				zap.String("tableID", table.TableID),
				zap.String("file", out.Name()),
			)
		}
	}
...
func (i *BigquerySingleCMD) Run(parent *BigqueryCMD, co *cmd.Commons) error {
	...
	l.Info(
		"Table collected",
		zap.String("projectID", i.ProjectID),
		zap.String("datasetID", i.DatasetID),
		zap.String("tableID", tableName),
		zap.String("file", out.Name()),
	)
